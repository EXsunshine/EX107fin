...
public class hard extends JFrame implements ActionListener,MouseListener,MouseMotionListener
{
    Container c;
    private Color color= Color.BLACK;
    private int m[][]=new int[5][10];
    private int xt,yt,xb,yb,xdir,ydir,flag,sum=50;
    Timer t;
    public hard()
    {
